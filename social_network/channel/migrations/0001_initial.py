    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admins', models.ManyToManyField(related_name='admins', to=settings.AUTH_USER_MODEL, verbose_name='Администраторы канала')),
                ...
                ('participents', models.ManyToManyField(blank=True, related_name='participents', to=settings.AUTH_USER_MODEL, verbose_name='Пользователи канала')),
            ],
            options={
                'verbose_name': 'Каналы',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='channel.post', verbose_name='Пост коментария')),
            ],
            options={
