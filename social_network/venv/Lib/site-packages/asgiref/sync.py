...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # account event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the account thread. This is achieved by idling
    ...
    # Storage for account event loop references
